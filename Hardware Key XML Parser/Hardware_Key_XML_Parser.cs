...
namespace Hardware_Key_XML_Parser
{
    public static class clsXMLParser
    {
        ...
        /// </summary>
        public static Dictionary<string, XmlNodeList> xNodeList;
        ...
        public static Dictionary<string, XmlNodeList> ReadXmlFile(string fileName)
        {
